...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. PinkachuCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "PinkachuCoin:"))
        {
            ...
            try {
                ...
                // don't log the "file not found" exception, PKCause that's normal for
    ...
    app.setOrganizationName("PinkachuCoin");
    app.setOrganizationDomain("we-have-no-domain-yet.nex");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("PinkachuCoin-qt-testnet");
    else
        app.setApplicationName("PinkachuCoin-qt");
